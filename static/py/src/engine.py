...
class Game:
    def __init__(self, nb_seeds_end=0, GUI=False):
        ...
        self.algos_available = ["alea", "alphabeta2", "alphabeta4", "alphabeta6", "alphabeta8", "alphabeta10",
                                ...
                                "fantome0","fantome2","fantome4","fantome6","fantome8"]
        self.is_playing = 0
    ...
    def run_game(self):
        ...
        while (self.nb_seeds_eaten < 48 - self.nb_seeds_end) \
            ...
            player = 0
            if (self.who_is_playing() == self.player1):
                player = 1
            print("pit chosen by player" + str(player) + ": " + str(pit))
            rslt_move = self.play(pit)
            print("loft player0:" + str(self.player0.loft))
            print("loft player1:" + str(self.player1.loft))
            print(self.b)
