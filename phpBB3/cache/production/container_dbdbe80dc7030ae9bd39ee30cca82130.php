...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000021f8ac49000000007cdacd4e(
...
class phpbbtemplatetwiglexer_0000000021f8ac49000000007cdacd4e extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5de981fc3f302193666936 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5de981fc3f30a481520276 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5de981fc3f2e6224388480 = array(
    ...
    {
        $this->initializer5de981fc3f30a481520276 && ($this->initializer5de981fc3f30a481520276->__invoke($valueHolder5de981fc3f302193666936, $this, 'set_environment', array('env' => $env), $this->initializer5de981fc3f30a481520276) || 1) && $this->valueHolder5de981fc3f302193666936 = $valueHolder5de981fc3f302193666936;

        return $this->valueHolder5de981fc3f302193666936->set_environment($env);
    }
    ...
    {
        $this->initializer5de981fc3f30a481520276 && ($this->initializer5de981fc3f30a481520276->__invoke($valueHolder5de981fc3f302193666936, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5de981fc3f30a481520276) || 1) && $this->valueHolder5de981fc3f302193666936 = $valueHolder5de981fc3f302193666936;

        return $this->valueHolder5de981fc3f302193666936->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5de981fc3f30a481520276 && ($this->initializer5de981fc3f30a481520276->__invoke($valueHolder5de981fc3f302193666936, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5de981fc3f30a481520276) || 1) && $this->valueHolder5de981fc3f302193666936 = $valueHolder5de981fc3f302193666936;

        return $this->valueHolder5de981fc3f302193666936->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5de981fc3f30a481520276 = $initializer;
    }
    ...
    {
        $this->initializer5de981fc3f30a481520276 && ($this->initializer5de981fc3f30a481520276->__invoke($valueHolder5de981fc3f302193666936, $this, '__get', array('name' => $name), $this->initializer5de981fc3f30a481520276) || 1) && $this->valueHolder5de981fc3f302193666936 = $valueHolder5de981fc3f302193666936;

        if (isset(self::$publicProperties5de981fc3f2e6224388480[$name])) {
            return $this->valueHolder5de981fc3f302193666936->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5de981fc3f302193666936;
    ...
    {
        $this->initializer5de981fc3f30a481520276 && ($this->initializer5de981fc3f30a481520276->__invoke($valueHolder5de981fc3f302193666936, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5de981fc3f30a481520276) || 1) && $this->valueHolder5de981fc3f302193666936 = $valueHolder5de981fc3f302193666936;
    ...
    {
        $this->initializer5de981fc3f30a481520276 && ($this->initializer5de981fc3f30a481520276->__invoke($valueHolder5de981fc3f302193666936, $this, '__isset', array('name' => $name), $this->initializer5de981fc3f30a481520276) || 1) && $this->valueHolder5de981fc3f302193666936 = $valueHolder5de981fc3f302193666936;
    ...
    {
        $this->initializer5de981fc3f30a481520276 && ($this->initializer5de981fc3f30a481520276->__invoke($valueHolder5de981fc3f302193666936, $this, '__unset', array('name' => $name), $this->initializer5de981fc3f30a481520276) || 1) && $this->valueHolder5de981fc3f302193666936 = $valueHolder5de981fc3f302193666936;
    ...
    {
        $this->initializer5de981fc3f30a481520276 && ($this->initializer5de981fc3f30a481520276->__invoke($valueHolder5de981fc3f302193666936, $this, '__clone', array(), $this->initializer5de981fc3f30a481520276) || 1) && $this->valueHolder5de981fc3f302193666936 = $valueHolder5de981fc3f302193666936;

        $this->valueHolder5de981fc3f302193666936 = clone $this->valueHolder5de981fc3f302193666936;
    }

    public function __sleep()
    {
        $this->initializer5de981fc3f30a481520276 && ($this->initializer5de981fc3f30a481520276->__invoke($valueHolder5de981fc3f302193666936, $this, '__sleep', array(), $this->initializer5de981fc3f30a481520276) || 1) && $this->valueHolder5de981fc3f302193666936 = $valueHolder5de981fc3f302193666936;

        return array('valueHolder5de981fc3f302193666936');
    }
    ...
    {
        return $this->initializer5de981fc3f30a481520276;
    }
    ...
    {
        return $this->initializer5de981fc3f30a481520276 && ($this->initializer5de981fc3f30a481520276->__invoke($valueHolder5de981fc3f302193666936, $this, 'initializeProxy', array(), $this->initializer5de981fc3f30a481520276) || 1) && $this->valueHolder5de981fc3f302193666936 = $valueHolder5de981fc3f302193666936;
    }
    ...
    {
        return null !== $this->valueHolder5de981fc3f302193666936;
    }
    ...
    {
        return $this->valueHolder5de981fc3f302193666936;
    }
