...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000003101cbb7000000000b57eddb(
...
class phpbbtemplatetwiglexer_000000003101cbb7000000000b57eddb extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5de982073c74e732247999 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5de982073c754545124019 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5de982073c73a182819137 = array(
    ...
    {
        $this->initializer5de982073c754545124019 && ($this->initializer5de982073c754545124019->__invoke($valueHolder5de982073c74e732247999, $this, 'set_environment', array('env' => $env), $this->initializer5de982073c754545124019) || 1) && $this->valueHolder5de982073c74e732247999 = $valueHolder5de982073c74e732247999;

        return $this->valueHolder5de982073c74e732247999->set_environment($env);
    }
    ...
    {
        $this->initializer5de982073c754545124019 && ($this->initializer5de982073c754545124019->__invoke($valueHolder5de982073c74e732247999, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5de982073c754545124019) || 1) && $this->valueHolder5de982073c74e732247999 = $valueHolder5de982073c74e732247999;

        return $this->valueHolder5de982073c74e732247999->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5de982073c754545124019 && ($this->initializer5de982073c754545124019->__invoke($valueHolder5de982073c74e732247999, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5de982073c754545124019) || 1) && $this->valueHolder5de982073c74e732247999 = $valueHolder5de982073c74e732247999;

        return $this->valueHolder5de982073c74e732247999->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5de982073c754545124019 = $initializer;
    }
    ...
    {
        $this->initializer5de982073c754545124019 && ($this->initializer5de982073c754545124019->__invoke($valueHolder5de982073c74e732247999, $this, '__get', array('name' => $name), $this->initializer5de982073c754545124019) || 1) && $this->valueHolder5de982073c74e732247999 = $valueHolder5de982073c74e732247999;

        if (isset(self::$publicProperties5de982073c73a182819137[$name])) {
            return $this->valueHolder5de982073c74e732247999->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5de982073c74e732247999;
    ...
    {
        $this->initializer5de982073c754545124019 && ($this->initializer5de982073c754545124019->__invoke($valueHolder5de982073c74e732247999, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5de982073c754545124019) || 1) && $this->valueHolder5de982073c74e732247999 = $valueHolder5de982073c74e732247999;
    ...
    {
        $this->initializer5de982073c754545124019 && ($this->initializer5de982073c754545124019->__invoke($valueHolder5de982073c74e732247999, $this, '__isset', array('name' => $name), $this->initializer5de982073c754545124019) || 1) && $this->valueHolder5de982073c74e732247999 = $valueHolder5de982073c74e732247999;
    ...
    {
        $this->initializer5de982073c754545124019 && ($this->initializer5de982073c754545124019->__invoke($valueHolder5de982073c74e732247999, $this, '__unset', array('name' => $name), $this->initializer5de982073c754545124019) || 1) && $this->valueHolder5de982073c74e732247999 = $valueHolder5de982073c74e732247999;
    ...
    {
        $this->initializer5de982073c754545124019 && ($this->initializer5de982073c754545124019->__invoke($valueHolder5de982073c74e732247999, $this, '__clone', array(), $this->initializer5de982073c754545124019) || 1) && $this->valueHolder5de982073c74e732247999 = $valueHolder5de982073c74e732247999;

        $this->valueHolder5de982073c74e732247999 = clone $this->valueHolder5de982073c74e732247999;
    }

    public function __sleep()
    {
        $this->initializer5de982073c754545124019 && ($this->initializer5de982073c754545124019->__invoke($valueHolder5de982073c74e732247999, $this, '__sleep', array(), $this->initializer5de982073c754545124019) || 1) && $this->valueHolder5de982073c74e732247999 = $valueHolder5de982073c74e732247999;

        return array('valueHolder5de982073c74e732247999');
    }
    ...
    {
        return $this->initializer5de982073c754545124019;
    }
    ...
    {
        return $this->initializer5de982073c754545124019 && ($this->initializer5de982073c754545124019->__invoke($valueHolder5de982073c74e732247999, $this, 'initializeProxy', array(), $this->initializer5de982073c754545124019) || 1) && $this->valueHolder5de982073c74e732247999 = $valueHolder5de982073c74e732247999;
    }
    ...
    {
        return null !== $this->valueHolder5de982073c74e732247999;
    }
    ...
    {
        return $this->valueHolder5de982073c74e732247999;
    }
